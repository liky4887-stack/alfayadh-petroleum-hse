...
const S = StyleSheet.create({
  ...
  tag: { color: '#FFFFFF', fontSize: 11, fontFamily: 'Chevalon-Bold', letterSpacing: 0.6 },
  title: { color: '#FFFFFF', fontSize: 20, fontFamily: 'Chevalon-ExtraBold', letterSpacing: -0.3, lineHeight: 26 },
  ...
  ctaText: { color: '#FFFFFF', fontSize: 14, fontFamily: 'Chevalon-Bold' },
