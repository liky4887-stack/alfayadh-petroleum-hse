...
const S = StyleSheet.create({
  ...
  brandName: { fontSize: 20, fontFamily: 'Chevalon-ExtraBold', letterSpacing: 2, color: C.ink, lineHeight: 22 },
  brandSubline: { fontSize: 8, fontFamily: 'Chevalon-Bold', letterSpacing: 1.5, color: C.accent, marginTop: 2 },
  iconBtn: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', borderRadius: 12 },
  cardPressed: { opacity: 0.6 },
  avatar: { width: 30, height: 30, borderRadius: 15, alignItems: 'center', justifyContent: 'center' },
  avatarText: { fontSize: 10, fontFamily: 'Chevalon-ExtraBold', color: C.ink },
  ...
  sectionLabel: { fontSize: 22, fontFamily: 'Chevalon-ExtraBold', color: C.ink, letterSpacing: -0.3 },
  sectionAction: { fontSize: 14, fontFamily: 'Chevalon-SemiBold', color: C.accent },
});
