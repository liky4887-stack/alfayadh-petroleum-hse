...
const S = StyleSheet.create({
  ...
  backText: { fontSize: 15, fontFamily: 'Chevalon-SemiBold', color: theme.text },
  headerTitle: { fontSize: 17, fontFamily: 'Chevalon-ExtraBold', color: theme.text, flex: 1, textAlign: 'center' },
  ...
  tabText: { fontSize: 12, fontFamily: 'Chevalon-SemiBold', color: theme.textDim },
  tabTextActive: { color: '#FFF', fontFamily: 'Chevalon-Bold' },
  ...
  deletedToggleText: { fontSize: 12, fontFamily: 'Chevalon-SemiBold', color: theme.textDim },
  deletedToggleActive: { backgroundColor: '#FEF7E0', borderColor: '#EA580C' },
  deletedToggleTextActive: { color: '#EA580C', fontFamily: 'Chevalon-Bold' },
  ...
  countText: { fontSize: 11, fontFamily: 'Chevalon-Bold', color: theme.primary },
  ...
  rowTitle: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: theme.text },
  rowTitleDeleted: { textDecorationLine: 'line-through', color: '#64748B' },
  deletedBadge: { fontSize: 10, fontFamily: 'Chevalon-Bold', color: '#DC2626', marginTop: 2, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  emptyText: { fontSize: 15, fontFamily: 'Chevalon-SemiBold', color: theme.textDim },
  ...
  auditBadgeText: { fontSize: 10, fontFamily: 'Chevalon-Bold' },
  auditTime: { fontSize: 11, color: theme.textDim },
  auditTable: { fontSize: 13, fontFamily: 'Chevalon-Bold', color: theme.text },
  auditId: { fontSize: 11, color: theme.textDim, marginTop: 2 },
  auditModalRow: { flexDirection: 'row', gap: 8, marginBottom: 6 },
  auditModalLabel: { fontSize: 12, fontFamily: 'Chevalon-SemiBold', color: theme.textDim, minWidth: 70 },
  auditModalValue: { fontSize: 12, fontFamily: 'Chevalon-Medium', color: theme.text, flex: 1 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', alignItems: 'center', justifyContent: 'center', padding: 24 },
  modalCard: { backgroundColor: theme.card, borderRadius: 16, padding: 20, width: '100%', gap: 8, maxHeight: '80%' },
  modalTitle: { fontSize: 18, fontFamily: 'Chevalon-ExtraBold', color: theme.text, marginBottom: 4 },
  modalSubtitle: { fontSize: 12, fontFamily: 'Chevalon-Bold', color: theme.textDim, marginTop: 8, textTransform: 'uppercase' },
  ...
  modalCloseText: { color: '#FFF', fontSize: 15, fontFamily: 'Chevalon-Bold' },
  pressed: { opacity: 0.7 },
});
