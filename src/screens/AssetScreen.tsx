...
const S = StyleSheet.create({
  ...
  emptyText: { fontSize: 14, fontFamily: 'Chevalon-Regular', color: '#64748B' },
  ...
  assetName: { fontSize: 16, fontFamily: 'Chevalon-Bold', color: '#0F172A' },
  assetCode: { fontSize: 13, fontFamily: 'Chevalon-Medium', color: '#64748B', marginTop: 2 },
  assetMeta: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 4 },
  assetLocation: { fontSize: 12, fontFamily: 'Chevalon-Regular', color: '#94A3B8' },
