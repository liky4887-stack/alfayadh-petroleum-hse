...
const S = StyleSheet.create({
  ...
  courseTitle: { fontSize: 22, fontWeight: '800', color: C.ink, marginTop: 16, paddingHorizontal: 20 },
  ...
  metaText: { fontSize: 13, fontWeight: '500', color: C.muted },
  ...
  progressTitle: { fontSize: 15, fontWeight: '700', color: C.ink },
  ...
  restoreBtnText: { fontSize: 16, fontWeight: '700', color: '#0EA5E9' },
