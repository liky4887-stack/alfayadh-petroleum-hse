...
const S = StyleSheet.create({
  ...
  avatarText: { fontSize: 28, fontFamily: 'Chevalon-ExtraBold', color: C.primary },
  avatarName: { fontSize: 20, fontFamily: 'Chevalon-ExtraBold', color: C.ink },
  avatarSub: { fontSize: 14, fontFamily: 'Chevalon-Medium', color: C.mutedLight },
  form: { gap: 18 },
  field: { gap: 8 },
