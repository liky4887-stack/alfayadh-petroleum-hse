...
const S = StyleSheet.create({
  ...
  brand: { fontSize: 28, fontFamily: 'Chevalon-ExtraBold', letterSpacing: 2, color: C.ink },
  subline: { fontSize: 11, fontFamily: 'Chevalon-Bold', letterSpacing: 2, color: C.accent, marginTop: 4 },
  form: { gap: 18 },
  field: { gap: 8 },
  ...
  errorText: { fontSize: 14, fontFamily: 'Chevalon-SemiBold', color: C.red },
  signInBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    backgroundColor: C.accent, paddingVertical: 16, borderRadius: 14, minHeight: 52, marginTop: 4,
  },
  signInText: { color: '#FFF', fontSize: 16, fontFamily: 'Chevalon-Bold' },
  btnDisabled: { opacity: 0.5 },
  footerText: { fontSize: 13, fontFamily: 'Chevalon-Medium', color: C.muted, textAlign: 'center', marginTop: 16 },
  pressed: { opacity: 0.7 },
});
