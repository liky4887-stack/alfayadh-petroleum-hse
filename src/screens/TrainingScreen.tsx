...
const S = StyleSheet.create({
  ...
  activeTab: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: C.ink, paddingVertical: 16, borderBottomWidth: 2.5, borderBottomColor: C.accent },
  inactiveTab: { fontSize: 15, fontFamily: 'Chevalon-SemiBold', color: C.muted, paddingVertical: 16 },
  scrollContent: { paddingBottom: 110 },
  body: { paddingHorizontal: 20, paddingTop: 8 },
  subHeading: { fontSize: 20, fontFamily: 'Chevalon-ExtraBold', color: C.ink, letterSpacing: -0.3, marginBottom: 14 },
  courseStrip: { gap: 12 },
  ...
  courseTitle: { fontSize: 14, fontFamily: 'Chevalon-Bold', color: C.ink, padding: 13, letterSpacing: -0.1, minHeight: 58 },
  ...
  progressTitle: { flex: 1, fontSize: 15, fontFamily: 'Chevalon-Bold', color: C.ink, minWidth: 0 },
  ...
  progressMeta: { fontSize: 13, fontFamily: 'Chevalon-Regular', color: C.muted, marginTop: 10 },
  ...
  quizProgress: { fontSize: 16, fontFamily: 'Chevalon-Bold', color: '#FFFFFF', fontVariant: ['tabular-nums'] },
  quizQuestion: { fontSize: 28, fontFamily: 'Chevalon-ExtraBold', color: '#FFFFFF', textAlign: 'center', marginTop: 80, lineHeight: 36, letterSpacing: -0.5 },
  quizSubtitle: { fontSize: 17, fontFamily: 'Chevalon-Medium', color: 'rgba(255,255,255,0.85)', textAlign: 'center', marginTop: 12 },
  ...
  quizOptionText: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: '#FFFFFF' },
  ...
  quizContinueText: { fontSize: 16, fontFamily: 'Chevalon-ExtraBold', color: C.accent },
