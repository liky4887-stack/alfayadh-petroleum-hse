...
const S = StyleSheet.create({
  ...
  stepLabel: { color: theme.textDim, fontSize: 12, fontWeight: '600' },
  stepContent: { gap: 16 },
  stepTitle: { color: theme.text, fontSize: 18, fontWeight: '700' },
  ...
  classifyText: { flex: 1 },
  classifyTitleRed: { color: theme.danger, fontSize: 17, fontWeight: '700' },
  ...
  backText: { color: theme.textDim, fontSize: 15, fontWeight: '600' },
  pressed: { opacity: 0.7 },
});
