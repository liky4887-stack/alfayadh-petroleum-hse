...
const S = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 18, fontFamily: 'Chevalon-ExtraBold', color: C.ink, marginTop: 16, marginBottom: 12 },
  faqList: { gap: 10 },
  ...
  faqQ: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: C.ink, flex: 1, marginRight: 12 },
  faqA: { fontSize: 14, fontFamily: 'Chevalon-Regular', color: C.mutedLight, paddingHorizontal: 16, paddingBottom: 16, lineHeight: 22 },
  contactList: { gap: 10 },
  contactCard: { backgroundColor: '#FFF', borderRadius: 14, borderWidth: 1, borderColor: C.borderLight, padding: 16 },
  contactInfo: { gap: 10 },
  contactName: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: C.ink },
  contactLinks: { gap: 8 },
  contactLink: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  contactLinkText: { fontSize: 14, fontFamily: 'Chevalon-Medium', color: C.primary },
  ...
  bugSubmitText: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: '#FFF' },
  ...
  aboutLabel: { flex: 1, fontSize: 15, fontFamily: 'Chevalon-SemiBold', color: C.ink },
  aboutValue: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: C.mutedLight, fontVariant: ['tabular-nums'] },
