...
const S = StyleSheet.create({
  ...
  cancelText: { fontSize: 15, fontFamily: 'Chevalon-SemiBold', color: C.muted },
  headerTitle: { fontSize: 17, fontFamily: 'Chevalon-ExtraBold', color: C.ink },
  scroll: { flex: 1 },
  scrollContent: { padding: 20, paddingBottom: 40, gap: 22 },
  field: { gap: 8 },
  label: { fontSize: 14, fontFamily: 'Chevalon-Bold', color: C.ink },
  ...
  chipText: { fontSize: 14, fontFamily: 'Chevalon-Medium', color: C.muted },
  chipTextSelected: { color: C.accent, fontFamily: 'Chevalon-Bold' },
  ...
  imageBtnText: { fontSize: 15, fontFamily: 'Chevalon-SemiBold', color: C.accent },
  ...
  errorText: { color: C.red, fontSize: 14, fontFamily: 'Chevalon-Medium' },
  ...
  saveBtnText: { color: '#FFF', fontSize: 16, fontFamily: 'Chevalon-Bold' },
  pressed: { opacity: 0.7 },
});
