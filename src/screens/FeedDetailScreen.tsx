...
const S = StyleSheet.create({
  ...
  categoryText: { fontSize: 10, fontWeight: '700', color: '#0EA5E9', letterSpacing: 0.4 },
  feedTitle: { fontSize: 22, fontWeight: '800', color: C.ink, letterSpacing: -0.3 },
  feedAuthor: { fontSize: 14, fontWeight: '500', color: C.muted },
  feedBody: { fontSize: 15, fontWeight: '400', color: C.ink, lineHeight: 24, marginTop: 8 },
  emptyText: { fontSize: 14, fontWeight: '500', color: C.muted },
