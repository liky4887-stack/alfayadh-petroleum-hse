...
const S = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 20, fontFamily: 'Chevalon-ExtraBold', color: C.ink },
  emptyText: { fontSize: 15, fontFamily: 'Chevalon-Regular', color: C.mutedLight, textAlign: 'center' },
  ...
  emptyBtnText: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: '#FFF' },
  grid: { padding: 20 },
