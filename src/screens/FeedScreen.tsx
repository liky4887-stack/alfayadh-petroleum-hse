...
import { X, Check, CheckCircle2, Eye, Play, Send } from '@/lib/icons';
...
const S = StyleSheet.create({
  ...
  ackText: { color: '#FFFFFF', fontSize: 13, fontFamily: 'Chevalon-Bold' },
  feedBody: { flex: 1 },
  ...
  feedTitle: { fontSize: 18, fontFamily: 'Chevalon-ExtraBold', color: C.ink, letterSpacing: -0.3 },
  feedSub: { fontSize: 14, fontFamily: 'Chevalon-Medium', color: C.muted, marginTop: 3 },
  ...
  engNum: { fontSize: 14, fontFamily: 'Chevalon-SemiBold', color: C.ink, fontVariant: ['tabular-nums'] },
  engComments: { fontSize: 13, fontFamily: 'Chevalon-Medium', color: C.inkSecondary, marginLeft: 'auto' },
  feedDescription: { padding: 16, fontSize: 15, fontFamily: 'Chevalon-Regular', color: C.ink, lineHeight: 24 },
  ...
  commentText: { fontSize: 14, fontFamily: 'Chevalon-Regular', color: C.ink, lineHeight: 21 },
  ...
  commentInput: { flex: 1, height: 44, borderWidth: 1, borderColor: C.border, borderRadius: 22, paddingHorizontal: 16, fontSize: 14, fontFamily: 'Chevalon-Regular', color: C.ink, backgroundColor: C.surfaceAlt },
