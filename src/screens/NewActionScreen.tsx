...
const S = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontFamily: 'Chevalon-ExtraBold', color: C.ink },
  scroll: { flex: 1 },
  scrollContent: { padding: 20, paddingBottom: 100 },
  form: { gap: 18 },
  field: { gap: 8 },
  fieldLabel: { fontSize: 14, fontFamily: 'Chevalon-Bold', color: C.ink },
  errorText: { fontSize: 12, fontFamily: 'Chevalon-SemiBold', color: C.errorLight },
  ...
  assetPickerText: { fontSize: 15, fontFamily: 'Chevalon-Medium', color: C.mutedLight },
  ...
  chipText: { fontSize: 14, fontFamily: 'Chevalon-Medium', color: C.inkLight },
  chipTextSelected: { fontFamily: 'Chevalon-Bold', color: C.primary },
  ...
  imagePlaceholderText: { fontSize: 14, fontFamily: 'Chevalon-Medium', color: C.mutedLight },
  previewWrap: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 20 },
  previewText: { fontSize: 14, fontFamily: 'Chevalon-SemiBold', color: C.accent },
  ...
  cancelText: { fontSize: 16, fontFamily: 'Chevalon-SemiBold', color: C.mutedLight },
  ...
  saveText: { fontSize: 16, fontFamily: 'Chevalon-Bold', color: '#FFF' },
  btnPressed: { opacity: 0.85 },
  btnDisabled: { opacity: 0.5 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', alignItems: 'center', justifyContent: 'center', padding: 24 },
  modalCard: { backgroundColor: '#FFF', borderRadius: 16, padding: 20, width: '100%' },
  modalTitle: { fontSize: 18, fontFamily: 'Chevalon-ExtraBold', color: C.ink, marginBottom: 14 },
  modalRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: C.border },
  modalRowInfo: { flex: 1 },
  modalRowTitle: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: C.ink },
  modalRowSub: { fontSize: 12, fontFamily: 'Chevalon-Medium', color: C.muted, marginTop: 2 },
  modalEmpty: { fontSize: 14, fontFamily: 'Chevalon-SemiBold', color: C.muted, textAlign: 'center', paddingVertical: 20 },
});
