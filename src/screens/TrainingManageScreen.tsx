...
const S = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontFamily: 'Chevalon-ExtraBold', color: C.ink, letterSpacing: -0.3 },
  ...
  addBtnText: { color: '#FFF', fontSize: 13, fontFamily: 'Chevalon-Bold' },
  ...
  statValue: { fontSize: 22, fontFamily: 'Chevalon-ExtraBold', color: C.ink, fontVariant: ['tabular-nums'] },
  statLabel: { fontSize: 11, fontFamily: 'Chevalon-SemiBold', color: C.muted },
  listContent: { paddingHorizontal: 20, paddingBottom: 100 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 24, marginBottom: 12 },
  sectionTitle: { fontSize: 18, fontFamily: 'Chevalon-ExtraBold', color: C.ink, letterSpacing: -0.2 },
  ...
  assignToggleText: { fontSize: 13, fontFamily: 'Chevalon-Bold', color: C.accent },
  ...
  courseTitle: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: C.ink, letterSpacing: -0.1 },
  courseMeta: { fontSize: 12, fontFamily: 'Chevalon-Medium', color: C.muted, marginTop: 3 },
  emptyState: { alignItems: 'center', justifyContent: 'center', paddingVertical: 60, gap: 12 },
  emptyTitle: { fontSize: 18, fontFamily: 'Chevalon-Bold', color: C.ink },
  emptyText: { fontSize: 14, fontFamily: 'Chevalon-Regular', color: C.muted, textAlign: 'center', lineHeight: 20, paddingHorizontal: 20 },
  ...
  backText: { fontSize: 14, fontFamily: 'Chevalon-SemiBold', color: C.accent },
  assignTitle: { fontSize: 17, fontFamily: 'Chevalon-ExtraBold', color: C.ink },
  ...
  checkmark: { color: '#FFF', fontSize: 14, fontFamily: 'Chevalon-ExtraBold' },
  empInfo: { flex: 1 },
  empName: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: C.ink },
  empMeta: { fontSize: 12, fontFamily: 'Chevalon-Medium', color: C.muted, marginTop: 2 },
  ...
  assignBtnText: { color: '#FFF', fontSize: 16, fontFamily: 'Chevalon-Bold' },
  ...
  pickerTitle: { fontSize: 18, fontFamily: 'Chevalon-ExtraBold', color: C.ink, marginBottom: 14 },
  ...
  pickerRowText: { fontSize: 15, fontFamily: 'Chevalon-SemiBold', color: C.ink },
  pickerCancel: { marginTop: 14, paddingVertical: 12, alignItems: 'center' },
  pickerCancelText: { fontSize: 15, fontFamily: 'Chevalon-SemiBold', color: C.muted },
  pressed: { opacity: 0.7 },
});
