...
const S = StyleSheet.create({
  ...
  editText: { fontSize: 14, fontFamily: 'Chevalon-Bold', color: '#0EA5E9' },
  ...
  actionTitle: { fontSize: 22, fontFamily: 'Chevalon-ExtraBold', color: C.ink, letterSpacing: -0.3 },
  ...
  infoLabel: { fontSize: 13, fontFamily: 'Chevalon-Bold', color: C.muted },
  descriptionText: { fontSize: 15, fontFamily: 'Chevalon-Regular', color: C.ink, lineHeight: 22, marginTop: 4 },
  ...
  metaValueLink: { fontSize: 15, fontFamily: 'Chevalon-Bold', color: '#0EA5E9', flex: 1 },
  emptyState: { alignItems: 'center', paddingVertical: 40, gap: 12 },
  emptyText: { fontSize: 14, fontFamily: 'Chevalon-Medium', color: C.muted, textAlign: 'center' },
  ...
  completeText: { fontSize: 16, fontFamily: 'Chevalon-Bold', color: '#16A34A' },
