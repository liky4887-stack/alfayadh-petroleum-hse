...
const S = StyleSheet.create({
  ...
  loginText: { fontSize: 16, fontFamily: 'Chevalon-Bold', color: '#FFF' },
  footerText: { fontSize: 13, fontFamily: 'Chevalon-Regular', color: C.mutedLight, marginTop: 24, textAlign: 'center' },
