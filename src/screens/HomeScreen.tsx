...
const S = StyleSheet.create({
  ...
  deptPillText: { fontSize: 13, fontFamily: 'Chevalon-Bold', color: '#FFFFFF' },
  ...
  outlinedBtnText: { fontSize: 14, fontFamily: 'Chevalon-Bold' },
  ...
  kpiCopy: { flex: 1 },
  kpiValue: { fontSize: 24, fontFamily: 'Chevalon-ExtraBold', color: '#0F172A', letterSpacing: -0.3, fontVariant: ['tabular-nums'] },
  kpiLabel: { fontSize: 13, fontFamily: 'Chevalon-Medium', color: '#64748B', marginTop: 2 },
  ...
  sectionLabel: { fontSize: 22, fontFamily: 'Chevalon-ExtraBold', color: '#0F172A', letterSpacing: -0.3 },
  ...
  countBadgeText: { color: '#FFFFFF', fontSize: 12, fontFamily: 'Chevalon-ExtraBold', fontVariant: ['tabular-nums'] },
  ...
  taskCategory: { fontSize: 11, fontFamily: 'Chevalon-Bold', color: '#0EA5E9', letterSpacing: 0.4, textTransform: 'uppercase' },
  taskTitle: { fontSize: 16, fontFamily: 'Chevalon-Bold', color: '#0F172A', marginTop: 5, letterSpacing: -0.2 },
  taskMetaRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 6 },
  taskMeta: { fontSize: 13, fontFamily: 'Chevalon-Regular', color: '#64748B' },
  ...
  headsTag: { fontSize: 10, fontFamily: 'Chevalon-Bold', color: '#0EA5E9', letterSpacing: 0.4, textTransform: 'uppercase' },
  headsTitle: { fontSize: 16, fontFamily: 'Chevalon-Bold', color: '#0F172A', marginTop: 6, minHeight: 44 },
  headsFooter: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 14 },
  headsAuthor: { fontSize: 13, fontFamily: 'Chevalon-Medium', color: '#64748B', flex: 1, minWidth: 0 },
  emptyState: { alignItems: 'center', paddingVertical: 40, gap: 12, paddingHorizontal: 20 },
  emptyText: { fontSize: 14, fontFamily: 'Chevalon-Medium', color: '#64748B', textAlign: 'center' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.4)', alignItems: 'center', justifyContent: 'center', padding: 24 },
  modalCard: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 20, width: '100%', gap: 4 },
  modalTitle: { fontSize: 18, fontFamily: 'Chevalon-Bold', color: '#0F172A' },
  modalSubtitle: { fontSize: 13, fontFamily: 'Chevalon-Regular', color: '#64748B', marginBottom: 12 },
  ...
  modalLabel: { fontSize: 15, fontFamily: 'Chevalon-Medium', color: '#0F172A' },
  modalLabelActive: { fontFamily: 'Chevalon-Bold', color: '#0EA5E9' },
